<?php session_start();
	#root path
	const 	TIENDA 	=	'http://10.177.78.54/subir_tienda/';	//http://tienda.grupoexpansion.mx
	const	ECOMMERCE = 'http://10.177.78.54/ecommerce/';	//http://pagos.grupoexpansion.mx
	...
	class API {
		...
		const 	API_URL	=	'http://10.177.78.54/ecommerce/api/';	//http://tienda.grupoexpansion.mx
		#API
