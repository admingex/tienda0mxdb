...
<form ACTION="logistica360_reno_paso.php" name=frmcaja METHOD="post" onSubmit="return checkFieldsTres(this)">
<table width="100%">
...
<td colspan="2" CLASS="instrucciones">
        	...
        	<b>A.</b> Si usted ya recibe Logistica 360 gratuitamente por favor
  ...
  <tr>
      <td colspan="2" >
          ...
          <b>S&iacute;, deseo renovar mi suscripci&oacute;n a la revista Logistica 360</b>
      </td>
 </tr>
...
<tr>
      <td class="label">
        Clave de Promocion Logistica 360:
        </td>
    <td>
