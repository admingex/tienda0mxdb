...
?>
		...
		Suscripcion gratuita para lectores calificados en M&eacute;xico.	
			...
			<p style="margin-left: 25px;">Con el fin de ofrecerle un servicio eficiente, rápido y seguro, es muy importante que proporcione correctamente sus datos. S
...
<tr>
  ...
  <tr>
      ...
      <td class="label_izq">
          ...
          Acepto suscribirme gratuitamente a seguridad 360
      </td>
 </tr>
    ...
    <tr>
      ...
      <td class="label_izq"> 
          ...
          Deseo suscribirme al New sletterde seguridad 360
      </td>
    </tr>
...
<td>
   <input type="text" class="text-long" name="nombre" size="30" maxlength="15" value="" />
    ...
    <a href="#" style="color: #BC1010;" onClick="javascript:zip('zip.php','POP')" >Ingresar 
