...
<!-- INICIO -->
<form ACTION="obras_nuevo_paso.php" name=frmcaja METHOD="post" onSubmit="return checkFieldsTres(this)">
<table width="100%">
<tr>
 ...
 <tr>
      <td colspan="2" class="instrucciones-paso">
        ...
        <b>A.</b> Para cancelar su suscripci&oacute;n gratuita a	Obras, simplemente llene sus datos.<br>
   ...
   <td class="label_izq">
          ...
          <b>Cancelar mi suscripci&oacute;n a la Obras</b>
           </td>
 </tr>
...
<tr>
	...
	<td class="label">
	T&iacute;tulo
	</td> <td class="label_izq" colspan="2">
        <input type="radio" value="21. Ingeniero" name="actividad1"   ID="actividad1" checked="checked" />
    ...
    <tr>
      ...
      <td colspan="2" class="label_izq">
        <input type="radio" value="22. Licenciado" name="actividad2"  ID="actividad2" />
    ...
    <tr>
      ...
      <td colspan="2" class="label_izq">
        <input type="radio" value="23. Arquitecto" name="actividad3" ID="actividad3"/>
