...
<td colspan="2" >
        <select name="actividad" id="actividad" onChange="validaOtro(this)">
           <option value="1. Direcci�n general">Direccion general</option>          
          <option value="2. Gerencia de planta/operaciones">Gerencia de planta/operaciones</option>          
          <option value="3. Producci�n/mantenimiento/control de calidad">Produccion/mantenimiento/control de calidad</option>          
          <option value="4. Ingenier�a">Ingenieria</option>          
