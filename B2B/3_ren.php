...
?>
		...
		<br>
		<p class="label_izq">Con el fin de ofrecerle un servicio eficiente, rápido y seguro, es muy importante que proporcione 
			correctamente sus datos. "Tienda GEx" le garantiza absoluta confidencialidad en la información proporcionada.</p>
		</section>
		<div id="pleca-punteada"></div>
		<section class="contenedor">	
		<div class="contenedor-gris">
		
<form ACTION="manuf_reno_paso.php" name=frmcaja METHOD="post" onSubmit="return checkFieldsTres(this)">
<table width="100%">
...
<td colspan="2" CLASS="instrucciones">
        	...
        	<b>A.</b> Si usted ya recibe Manufactura gratuitamente por favor
  ...
  <tr>
      <td colspan="2" >
          ...
          <b>S&iacute;, deseo renovar mi suscripci&oacute;n a la revista Manufactura</b>
      </td>
 </tr>
    ...
    <tr>
      <td colspan="2" >
        <div id="divtipo_e360_inicio3" class="checkbox_selected">&nbsp;					
          ...
          <b>Si me interesa recibir informacion por e-mail sobre nuevos</b><br>
      </td>
    </tr>
