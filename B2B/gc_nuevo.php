...
?>
		...
		<p style="margin-left: 25px;">Con el fin de ofrecerle un servicio eficiente, rápido y seguro, es muy importante que proporcione correctamente sus datos. Kiosco le garantiza absoluta confidencialidad en la información proporcionada.</p>
		</section>
		<div id="pleca-punteada"></div>
		<section class="contenedor">	
				
<form ACTION="gc_nuevo_paso.php" name="frmcaja" id="frmcaja" METHOD="post" onSubmit="return checkFields(this)">
<table width="100%">
...
<tr>
  ...
  <tr>
      ...
      <td class="label_izq">
          ...
          Acepto suscribirme gratuitamente a Gu&iacute;a de compras
      </td>
 </tr>
    ...
    <tr>
      ...
      <td class="label_izq"> 
          ...
          Deseo suscribirme al New sletterde Gu&iacute;a de compras
      </td>
    </tr>
