...
<!-- INICIO -->
<form ACTION="ointeriores_reno_paso.php" name="frmcaja" METHOD="post" onSubmit="return checkFieldsTres(this)">
<table width="100%">
...
<td colspan="2" CLASS="instrucciones">
        	...
        	<b>A.</b> Si usted ya recibe O_Interiores gratuitamente por favor
  ...
  <tr>
      <td colspan="2" >
          ...
          <b>S&iacute;, deseo renovar mi suscripci&oacute;n a la revista O_Interiores</b>
      </td>
 </tr>
	...
	<tr>
      <td class="label">
        ...
        de Cliente:</td>
      <td ><input type="text" name="cliente" size="5" maxlength="8" 
