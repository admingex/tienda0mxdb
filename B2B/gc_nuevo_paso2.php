...
Compras</td>
    ...
    <tr>
      ...
      <td colspan="2" class="label_izq">
        <input type="radio" value="22. Dise�a" name="actividad2"  ID="actividad2" />
...
<tr>
    ...
    <tr> 
     ...
     <tr> 
            <td COLSPAN="2" class="label_izq">
        <input type="checkbox" value="D. Recomendaci�n" name="med4" ID="med4">
      ...
      <td  colspan="2" class="label_izq" />
        ...
        <select name="construye">
          <option value="-1">1. Edificaci&oacute;n (seleccione)</option>
		            ...
		            <option value="6 Hospitales y clinicas">|---   1.6 Hospitales y clínicas</option>
					<option value="7 Edificaciones para recreaci�n y esparcimiento">|---   1.7 Edificaciones para recreación y esparcimiento</option>
