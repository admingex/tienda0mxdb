...
<div class="encabezado-descripcion">Resumen de orden <input value="Regresar" type="button" onclick="document.getElementById('boton_historial').click()" class="boton-guardar" style='float: right; margin-right: 10px'></div>	
<?php
	...
	if($compra){
		...
		echo "	<div class='encabezado-descripcion'>Datos generados</div>
				<div class='contenedor1'>
					<div class='clear'>
						<span class='info-blanco'>Fecha de Orden: </span>
						<span class='info-rojo'>".$compra['fecha_compra']."</span>
					</div>
					<div class='clear'>
						<span class='info-blanco'>Número de Orden: </span>
						<span class='info-rojo'>".$compra['id_compra']."</span>
					</div>
					<div class='clear'>
						<span class='info-blanco'>importe total: </span>
		...
		echo "	<div class='encabezado-descripcion'>Información de pagos</div>
				<div class='contenedor1'>
					<span class='info-blanco'>Pagado con: </span>
		...
		echo "	<div class='encabezado-descripcion'>Información de facturación</div>
				<div class='contenedor1'>
					...
					<div class='info-blanco'>".$compra['razon_social']."</div>					
				</div>
				<div class='contenedor1'>
					<div class='info-rojo'>Dirección de facturación</div>
					<div class='info-blanco'>".$compra['dir_facturacion']."</div>
				</div>";
		}	
